...
Geliştirilen özel backtesting motoru, üretilen ticaret stratejilerinin geçmiş veriler üzerindeki performansını gerçekçi piyasa koşullarında simüle etmektedir. 

Simülasyonun gerçekçiliğini ve güvenilirliğini en üst düzeye çıkarmak amacıyla sisteme şu kısıtlar ve kurallar entegre edilmiştir:
...
* **Performans Değerlendirme (Fitness Function):** Mekanizma, strateji başarısını aşağıdaki temel finansal metrikler üzerinden hesaplayarak Genetik Algoritma'nın uyumluluk (*fitness*) fonksiyonuna geri bildirim sağlamaktadır:
